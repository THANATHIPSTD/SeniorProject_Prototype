    ...
    return (
        <div className="space-y-2">
            <div className="flex items-center justify-between text-xs text-slate-400 font-semibold">
                <span>{min}</span>
                <span className="px-2 py-0.5 rounded-md bg-slate-100 text-slate-700 font-bold">{numericValue.toFixed(step < 1 ? 1 : 0)} mm</span>
                <span>{max}</span>
            </div>
            <input
                type="range"
...
const VisualCard = ({ id, label, svgType, isSelected, onClick, cardClassName, iconClassName }: { id: string; label: string; svgType: string; isSelected: boolean; onClick: () => void; cardClassName?: string; iconClassName?: string }) => (
    <div
        data-id={id}
        onClick={onClick}
        className={cn(
    ...
    >
        <DentalIcon type={svgType} className={cn(isSelected ? "border-teal-200 bg-white" : "border-slate-100 group-hover:border-slate-200", iconClassName)} />
        <span>{label}</span>
    </div>
);
...
const DEFAULT_STATE: FormState = {
    ...
    seeDoctorRegularly: 'no', allergyStatus: 'no', allergyDetails: '',
    dentalHistory: '',
    patientExpectation: [],
...
export default function SequentialPatientPage() {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 relative">
            ...
            {/* Main Layout Area */}
            <div className="flex-1 flex overflow-hidden max-w-400 mx-auto w-full">
                        ...
                        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
                                ...
                                <div className="p-6 space-y-8">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-slate-100 pb-8">
                                        ...
                                        <div className="space-y-4 flex flex-col justify-center">
                                            <Label className="text-sm font-bold text-slate-700">Regular Doctor Visits? <span className="text-slate-400 font-normal ml-1">(พบแพทย์เป็นประจำหรือไม่)</span></Label>
                                            <RadioGroup
                                                value={formData.seeDoctorRegularly}
                                                onValueChange={(v) => updateField('seeDoctorRegularly', v)}
                                    ...
                                    <div className="bg-blue-50/50 p-5 rounded-xl border border-blue-100 space-y-4">
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                <RadioGroupItem value="no" id="allergy-no" className="text-blue-600 border-slate-300" />
                            ...
                            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                                ...
                                <div className="p-6 space-y-8">
                                    ...
                                    <div className="space-y-3">
                                        <Label htmlFor="selfEvaluation" className="text-sm font-bold text-slate-700">Patient self evaluation of current dental/prostheses status</Label>
                                        <Textarea
                                            id="selfEvaluation"
                                ...
                                <div className="p-6 space-y-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-slate-100 pt-8">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                {['None', 'To the left', 'To the right'].map(opt => (
                                                    <div
                                                        key={opt}
                                                        onClick={() => updateField('jawDeviation', opt.toLowerCase())}
                                                        className={cn(
                                                            "px-4 py-3 rounded-xl border-2 cursor-pointer transition-all flex items-center justify-center text-sm font-semibold select-none",
                                                            formData.jawDeviation === opt.toLowerCase()
                                                                ? "border-teal-500 bg-teal-50 text-teal-900 shadow-sm"
                                                                : "border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50"
                                                        )}
                                                    >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-slate-100 pt-8">
                                        <div className="space-y-4">
                                            <Label className="text-sm font-bold text-slate-700">Limited Mouth Opening?</Label>
                                            <RadioGroup
                                                value={formData.limitedOpening}
                                                onValueChange={(v) => { updateField('limitedOpening', v); if (v === 'no') updateField('openingMm', ''); }}
                                                className="flex gap-6"
                                            >
                                                <div className="flex items-center gap-2 cursor-pointer">
                                                    <RadioGroupItem value="no" id="open-no" className="text-teal-600" />
                                                    <Label htmlFor="open-no" className="cursor-pointer">No</Label>
                                                </div>
                                                <div className="flex items-center gap-2 cursor-pointer">
                                                    <RadioGroupItem value="yes" id="open-yes" className="text-rose-500 border-rose-300 data-[state=checked]:border-rose-500" />
                                                    <Label htmlFor="open-yes" className="cursor-pointer font-semibold text-rose-600">Yes</Label>
                                                </div>
                                            </RadioGroup>

                                            {formData.limitedOpening === 'yes' && (
                                                <div className="animate-in fade-in slide-in-from-top-2 duration-300 max-w-xs">
                                                    <MmSlider
                                                        value={formData.openingMm}
                                                        onChange={(v) => updateField('openingMm', v)}
                                                        min={0}
                                                        max={60}
                                                        step={1}
                    ...
                    {activeSection === 'esthetic' && (
                        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
                                    ...
                                    <div className="space-y-3 md:col-span-2 border-t border-slate-100 pt-6">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                                            ...
                                            {formData.facialMidline !== 'symmetric' && (
                                                <div className="w-full md:w-56 animate-in fade-in zoom-in-95 duration-200">
                                                    <MmSlider
                                                        value={formData.facialMidlineMm}
                                                        onChange={(v) => updateField('facialMidlineMm', v)}
                                                        min={0}
                                                        max={10}
                                                        step={0.5}
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex-1">
                                                    <MmSlider
                                                        ...
                                                        onChange={(v) => updateField('toothExpUpper', v)}
                                                        min={0}
                                                        max={10}
                                                        step={0.5}
                                                    />
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="flex-1">
                                                    <MmSlider
                                                        ...
                                                        onChange={(v) => updateField('toothExpLower', v)}
                                                        min={0}
                                                        max={10}
                                                        step={0.5}
                                                    />
                            ...
                            <div className="bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden text-white">
                                <div className="bg-slate-800/80 border-b border-slate-700/50 px-6 py-5 flex items-center gap-3 backdrop-blur-sm">
                                    <div className="p-2 bg-teal-500/20 rounded-lg">
                                        <Smile className="w-5 h-5 text-teal-400" />
                                    </div>
                                    <h3 className="font-bold text-lg text-white">3. Dentofacial Analysis</h3>
                                </div>
                                ...
                                <div className="p-6 lg:p-10 space-y-12">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                <VisualCard id="average" label="Average" svgType="smile-avg" isSelected={formData.smileLine === 'average'} onClick={() => updateField('smileLine', 'average')} />
                                                <VisualCard id="high" label="High" svgType="smile-high" isSelected={formData.smileLine === 'high'} onClick={() => updateField('smileLine', 'high')} />
                                                <VisualCard id="low" label="Low" svgType="smile-low" isSelected={formData.smileLine === 'low'} onClick={() => updateField('smileLine', 'low')} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                <VisualCard id="convex" label="Convex Curve" svgType="curve-convex" isSelected={formData.incisalCurve === 'convex'} onClick={() => updateField('incisalCurve', 'convex')} />
                                                <VisualCard id="straight" label="Straight" svgType="curve-straight" isSelected={formData.incisalCurve === 'straight'} onClick={() => updateField('incisalCurve', 'straight')} />
                                                <VisualCard id="reverse" label="Reverse" svgType="curve-reverse" isSelected={formData.incisalCurve === 'reverse'} onClick={() => updateField('incisalCurve', 'reverse')} />
                                            </div>
                                        </div>
                                    </div>

                                    {/* ROW 2 */}
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 pt-10 border-t border-slate-800/60">
                                        <div className="space-y-4">
                                            <Label className="text-sm font-bold text-teal-400 uppercase tracking-widest flex items-center gap-2">
                                                <span className="w-1.5 h-1.5 rounded-full bg-teal-400"></span> Midline (Philtrum)
                                            </Label>
                                            <div className="grid grid-cols-3 gap-3">
                                                <VisualCard id="center" label="Center" svgType="mid-center" isSelected={formData.midlinePhiltrum === 'center'} onClick={() => updateField('midlinePhiltrum', 'center')} />
                                                <VisualCard id="right" label="Right" svgType="mid-right" isSelected={formData.midlinePhiltrum === 'right'} onClick={() => updateField('midlinePhiltrum', 'right')} />
                                                <VisualCard id="left" label="Left" svgType="mid-left" isSelected={formData.midlinePhiltrum === 'left'} onClick={() => updateField('midlinePhiltrum', 'left')} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                                <VisualCard id="6" label="6 Teeth" svgType="teeth-6" isSelected={formData.teethExposed === '6'} onClick={() => updateField('teethExposed', '6')} />
                                                <VisualCard id="8" label="8 Teeth" svgType="teeth-8" isSelected={formData.teethExposed === '8'} onClick={() => updateField('teethExposed', '8')} />
                                                <VisualCard id="10" label="10 Teeth" svgType="teeth-10" isSelected={formData.teethExposed === '10'} onClick={() => updateField('teethExposed', '10')} />
                                                <VisualCard id="16" label="16 Teeth" svgType="teeth-16" isSelected={formData.teethExposed === '16'} onClick={() => updateField('teethExposed', '16')} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 pt-10 border-t border-slate-800/60">
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                <VisualCard id="touching" label="Touching" svgType="lip-touching" isSelected={formData.lipPosition === 'touching'} onClick={() => updateField('lipPosition', 'touching')} />
                                                <VisualCard id="not-touching" label="Not Touching" svgType="lip-not-touching" isSelected={formData.lipPosition === 'not-touching'} onClick={() => updateField('lipPosition', 'not-touching')} />
                                                <VisualCard id="slightly-covered" label="Covered" svgType="lip-covered" isSelected={formData.lipPosition === 'slightly-covered'} onClick={() => updateField('lipPosition', 'slightly-covered')} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-3 gap-3">
                                                <VisualCard id="right" label="Right" svgType="mid-ul-right" isSelected={formData.midlineIncisors === 'right'} onClick={() => updateField('midlineIncisors', 'right')} />
                                                <VisualCard id="left" label="Left" svgType="mid-ul-left" isSelected={formData.midlineIncisors === 'left'} onClick={() => updateField('midlineIncisors', 'left')} />
                                                <VisualCard id="straight" label="Straight" svgType="mid-ul-straight" isSelected={formData.midlineIncisors === 'straight'} onClick={() => updateField('midlineIncisors', 'straight')} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="pt-10 border-t border-slate-800/60">
                                        <div className="space-y-4 max-w-lg mx-auto text-center">
                                            <Label className="text-sm font-bold text-teal-400 uppercase tracking-widest flex items-center justify-center gap-2">
                                                <span className="w-1.5 h-1.5 rounded-full bg-teal-400"></span> Buccal Corridor
                                            </Label>
                                            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
                                                <VisualCard id="normal" label="Normal" svgType="buccal-normal" isSelected={formData.buccalCorridor === 'normal'} onClick={() => updateField('buccalCorridor', 'normal')} cardClassName="p-2.5" iconClassName="h-12 sm:h-14" />
                                                <VisualCard id="increased" label="Increased" svgType="buccal-increased" isSelected={formData.buccalCorridor === 'increased'} onClick={() => updateField('buccalCorridor', 'increased')} cardClassName="p-2.5" iconClassName="h-12 sm:h-14" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-4 pt-1">
                                            <div>
                                                <MmSlider
                                                    ...
                                                    onChange={(v) => updateField('sSoundMm', v)}
                                                    min={0}
                                                    max={5}
                                                    step={0.1}
                                        ...
                                        <div className="space-y-4 pt-1">
                                            <div>
                                                <MmSlider
                                                    ...
                                                    onChange={(v) => updateField('closestSpeakingSpace', v)}
                                                    min={0}
                                                    max={10}
                                                    step={0.5}
                                                    accentClass="accent-teal-500"
                                ...
                                <div className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                                    ...
                                    <div className="space-y-2 w-full md:w-1/2">
                                        ...
                                        <MmSlider
                                            ...
                                            onChange={(v) => {
                                                updateField('vdoFreewaySpaceMm', v);
                                                updateField('freewaySpace', v);
                                            }}
                                            min={0}
                                            max={10}
                                            step={0.5}
                                            accentClass={isVdoLost ? 'accent-rose-500' : 'accent-teal-500'}
                                        />
                                    </div>
