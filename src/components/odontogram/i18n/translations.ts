 ...
 * | ru   | Russian   |
 */
export type Language = "hu" | "en" | "de" | "es" | "it" | "sk" | "pl" | "ru" | "th";
...
export const translations: Record<Language, Record<string, string>> = {
  hu: {
    ...
    "chart.hint": "Kattints egy fogra a lépésenkénti varázsló megnyitásához.",
  ...
  en: {
    ...
    "chart.hint": "Click one tooth to open the step-by-step charting wizard.",
  ...
  th: {
    "app.title": "โมดูลแผนผังสถานะฟัน",
    "app.subtitle": "เลือกซี่ฟันบนแผนผัง แล้วกำหนดรายละเอียด",
    "topbar.exportStatus": "ส่งออกสถานะ",
    "topbar.importStatus": "นำเข้าสถานะ",
    "chart.title": "แผนผังสถานะฟัน",
    "chart.hint": "คลิกฟันหนึ่งซี่เพื่อเปิดวิซาร์ดบันทึกทีละขั้นตอน",
    "chart.actions.occlusal": "แสดงผลด้านสบฟัน",
    "chart.actions.wisdom": "แสดงฟันคุด",
    "chart.actions.bone": "แสดงกระดูก",
    "chart.actions.pulp": "แสดงโพรงประสาทฟัน",
    "chart.actions.clearSelection": "ยกเลิกการเลือก",
    "chart.aria.toothGrid": "ตารางฟัน",
    "panel.controls": "ส่วนควบคุม",
    "panel.clearSelection": "ยกเลิกการเลือก",
    "panel.toggleControls": "เปิด/ปิด ส่วนควบคุม",
    "panel.activeTooth": "ฟันที่กำลังเลือก",
    "panel.selectActions.all": "ทั้งหมด",
    "panel.selectActions.present": "ฟันที่มีอยู่",
    "panel.selectActions.permanent": "ฟันแท้",
    "panel.selectActions.milk": "ฟันน้ำนม",
    "panel.selectActions.implants": "รากเทียม",
    "panel.selectActions.missing": "ฟันที่หายไป",
    "panel.selectActions.upper": "ฟันบน",
    "panel.selectActions.upperFront": "ฟันหน้าบน 6 ซี่",
    "panel.selectActions.upperMolar": "ฟันกรามบน",
    "panel.selectActions.lower": "ฟันล่าง",
    "panel.selectActions.lowerFront": "ฟันหน้าล่าง 6 ซี่",
    "panel.selectActions.lowerMolar": "ฟันกรามล่าง",
    "status.title": "สถานะ",
    "status.resetAll": "รีเซ็ตสถานะช่องปาก",
    "status.primaryDentition": "ชุดฟันน้ำนม",
    "status.mixedDentition": "ชุดฟันผสม",
    "status.edentulous": "ไม่มีฟัน",
    "status.extraLabel": "เพิ่ม:",
    "status.extraApply": "ตกลง",
    "tooth.title": "รายละเอียดฟัน",
    "tooth.reset": "รีเซ็ต",
    "tooth.resetTitle": "รีเซ็ตฟันเป็นค่าเริ่มต้น",
    "tooth.baseLabel": "พื้นฐาน",
    "tooth.bridgeLabel": "ฟันเทียม",
    "tooth.extractionWound": "แผลถอนฟันใหม่",
    "tooth.crownLabel": "ครอบฟัน",
    "tooth.broken.mesial": "ด้านใกล้กลาง (Mesial)",
    "tooth.broken.incisal": "ด้านขอบตัด (Incisal)",
    "tooth.broken.distal": "ด้านไกลกลาง (Distal)",
    "tooth.contact.mesialMissing": "ไม่มีจุดสัมผัสด้านใกล้กลาง",
    "tooth.contact.distalMissing": "ไม่มีจุดสัมผัสด้านไกลกลาง",
    "tooth.bruxism.edgeWear": "ฟันสึกด้านขอบตัด",
    "tooth.bruxism.neckWear": "ฟันสึกบริเวณคอฟัน",
    "tooth.bridgePillar": "เป็นหลักยึดสะพานฟัน",
    "tooth.extractionPlan": "แผนจะถอนฟัน",
    "tooth.crownReplace": "รื้อครอบฟัน / ทำใหม่",
    "tooth.crownNeeded": "จำเป็นต้องทำครอบฟัน",
    "tooth.missingClosed": "ช่องว่างปิด",
    "caries.title": "รอยผุ",
    "caries.hint": "เลือกด้านที่พบรอยผุ",
    "filling.title": "วัสดุอุดฟัน / ครอบฟันชั่วคราว",
    "filling.typeLabel": "ประเภท",
    "filling.fissureSealing": "เคลือบหลุมร่องฟัน",
    "endo.title": "รากฟัน",
    "endo.hint": "เลือกสถานะรากฟัน",
    "endo.pulpitis": "โพรงประสาทฟันอักเสบ",
    "endo.resection": "ตัดปลายรากฟัน",
    "endo.parapulpalPin": "หมุดยึดวัสดุอุดฟัน",
    "inflammation.title": "อวัยวะปริทันต์และการอักเสบ",
    "inflammation.mobilityLabel": "ฟันโยก",
    "language.label": "ภาษา / Language",
    "language.hu": "🇭🇺 Hungarian",
    "language.en": "🇬🇧 English",
    "language.de": "🇩🇪 German",
    "language.es": "🇪🇸 Spanish",
    ...
    "language.ru": "🇷🇺 Russian",
    "language.th": "🇹🇭 ไทย",
    "numbering.label": "ระบบระบุตำแหน่งฟัน",
    "numbering.fdi": "FDI (สากล)",
    "numbering.universal": "Universal (อเมริกา)",
    "numbering.palmer": "Palmer",
    "theme.light": "โหมดสว่าง",
    "theme.dark": "โหมดมืด",
    "selection.none": "—",
    "selection.count": "{{count}} ซี่",
    "toothSelect.none": "ฟันที่หายไป",
    "toothSelect.permanent": "ฟันแท้",
    "toothSelect.milk": "ฟันน้ำนม",
    "toothSelect.implant": "รากเทียม",
    "toothSelect.crownPrep": "กรอฟันสำหรับทำครอบ",
    "toothSelect.underGum": "ฟันอยู่ใต้เหงือก",
    "endo.option.none": "รากฟันปกติ",
    "endo.option.medicalFilling": "รักษารากฟัน (ใส่ยา)",
    "endo.option.filling": "อุดรากฟัน",
    "endo.option.incompleteFilling": "อุดรากฟันไม่สมบูรณ์",
    "endo.option.glassPin": "อุดรากฟันพร้อมเดือยไฟเบอร์",
    "endo.option.metalPin": "อุดรากฟันพร้อมเดือยโลหะ",
    "filling.option.none": "ไม่มีวัสดุอุด",
    "filling.option.amalgam": "อุดอมัลกัม",
    "filling.option.composite": "อุดคอมโพสิตเรซิน",
    "filling.option.gic": "อุดจีไอซี (GIC)",
    "filling.option.temporary": "อุดชั่วคราว",
    "crown.option.noneImplant": "ไม่มี",
    "crown.option.healingAbutment": "Healing abutment",
    "crown.option.zircon": "ครอบฟันเซอร์โคเนีย",
    "crown.option.metal": "ครอบฟันโลหะเคลือบพอร์ซเลน",
    "crown.option.temporary": "ครอบฟันชั่วคราว",
    "crown.option.locator": "โลเคเตอร์",
    "crown.option.locatorProsthesis": "โลเคเตอร์ + ฟันเทียม",
    "crown.option.bar": "รากเทียมชนิดแกน (Bar)",
    "crown.option.barProsthesis": "แกน + ฟันเทียม",
    "crown.option.full": "ครอบฟันเต็มซี่",
    "crown.option.broken": "ครอบฟันแตกหัก",
    "crown.option.radix": "เหลือแต่ราก (Radix)",
    "crown.option.emax": "อินเลย์เซรามิก",
    "crown.option.telescope": "ครอบฟันเทเลสโคปิค",
    "bridge.option.none": "ไม่มี",
    "bridge.option.removable": "ฟันเทียมถอดได้",
    "bridge.option.zircon": "สะพานฟันเซอร์โคเนีย",
    "bridge.option.metal": "สะพานฟันโลหะเคลือบพอร์ซเลน",
    "bridge.option.temporary": "สะพานฟันชั่วคราว",
    "bridge.option.bar": "โครงสร้างสะพานแท่ง",
    "bridge.option.barProsthesis": "แท่งบาร์ + ฟันเทียม",
    "mobility.none": "ไม่โยก",
    "mobility.m1": "ระดับ 1",
    "mobility.m2": "ระดับ 2",
    "mobility.m3": "ระดับ 3",
    "mods.parodontal": "ปริทันต์อักเสบ",
    "mods.periimplantitis": "Peri-implantitis",
    "mods.periodontalInflammation": "โรคเหงือกอักเสบ",
    "mods.periapicalInflammation": "ปลายรากอักเสบ",
    "surface.mesial": "ด้านใกล้กลาง (mesial)",
    "surface.distal": "ด้านไกลกลาง (distal)",
    "surface.buccal": "ด้านแก้ม (buccal)",
    "surface.lingual": "ด้านลิ้น (lingual)",
    "surface.palatal": "ด้านเพดาน (palatal)",
    "surface.occlusal": "ด้านสบฟัน (occlusal)",
    "surface.subcrown": "ใต้ครอบฟัน",
    "actions.expand": "เปิด {{label}}",
    "actions.collapse": "ปิด {{label}}",
    "debug.numbering.title": "การตรวจสอบระบบระบุฟัน",
    "statusExtras.upper12_22Zircon": "ครอบฟันเซอร์โคเนีย บน 12-22",
    "statusExtras.upper13_23Zircon": "ครอบฟันเซอร์โคเนีย บน 13-23",
    "statusExtras.upper16_26Zircon": "ครอบฟันเซอร์โคเนีย บน 16-26",
    "statusExtras.upperFullZircon": "สะพานฟันเซอร์โคเนีย เต็มซี่บน",
    "statusExtras.upper12_22Metal": "ครอบฟันโลหะ บน 12-22",
    "statusExtras.upper13_23Metal": "ครอบฟันโลหะ บน 13-23",
    "statusExtras.upper16_26Metal": "ครอบฟันโลหะ บน 16-26",
    "statusExtras.upperFullMetal": "สะพานฟันโลหะ เต็มซี่บน",
    "statusExtras.upperPartialRemovable": "ฟันเทียมบางส่วน บน",
    "statusExtras.upperFullRemovable": "ฟันเทียมทั้งปาก บน",
    "statusExtras.upperBarDenture": "ฟันเทียมสวมทับบาร์ บน",
    "statusExtras.lower42_32Zircon": "ครอบฟันเซอร์โคเนีย ล่าง 42-32",
    "statusExtras.lower43_33Zircon": "ครอบฟันเซอร์โคเนีย ล่าง 43-33",
    "statusExtras.lower46_36Zircon": "ครอบฟันเซอร์โคเนีย ล่าง 46-36",
    "statusExtras.lowerFullZircon": "สะพานฟันเซอร์โคเนีย เต็มซี่ล่าง",
    "statusExtras.lower42_32Metal": "ครอบฟันโลหะ ล่าง 42-32",
    "statusExtras.lower43_33Metal": "ครอบฟันโลหะ ล่าง 43-33",
    "statusExtras.lower46_36Metal": "ครอบฟันโลหะ ล่าง 46-36",
    "statusExtras.lowerFullMetal": "สะพานฟันโลหะ เต็มซี่ล่าง",
    "statusExtras.lowerPartialRemovable": "ฟันเทียมบางส่วน ล่าง",
    "statusExtras.lowerFullRemovable": "ฟันเทียมทั้งปาก ล่าง",
    "statusExtras.lowerBarDenture": "ฟันเทียมสวมทับบาร์ ล่าง"
  },
  de: {
    "app.title": "React Odontogram Editor Modul",
    ...
    "chart.hint": "Klicke einen Zahn an, um den Schritt-für-Schritt-Assistenten zu öffnen.",
  ...
  es: {
    ...
    "chart.hint": "Haz clic en un diente para abrir el asistente paso a paso.",
  ...
  it: {
    ...
    "chart.hint": "Clicca un dente per aprire la procedura guidata passo passo.",
  ...
  sk: {
    ...
    "chart.hint": "Klikni na jeden zub a otvor krokový sprievodca.",
  ...
  pl: {
    ...
    "chart.hint": "Kliknij jeden ząb, aby otworzyć kreator krok po kroku.",
  ...
  ru: {
    ...
    "chart.hint": "Нажмите один зуб, чтобы открыть пошаговый мастер.",
