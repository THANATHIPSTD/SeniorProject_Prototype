      ...
      <div className="mt-12 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-12 px-8 rounded-xl border border-gray-200 sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Link to="/auth/login" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-slate-600 bg-slate-50 hover:bg-slate-100">
                Sign in instead
              </Link>
            </div>
          </div>
