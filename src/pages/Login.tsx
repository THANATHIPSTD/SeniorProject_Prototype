...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (email && password) {
      // Mock login sequence
      login(
        { id: '1', name: 'Dr. IDRS Admin', email, role: 'dentist' },
        'mock-jwt-token-idrs-12345'
      );
      navigate('/dashboard');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-8 text-center text-4xl font-semibold text-black tracking-tight">
          Welcome to IDRS
        </h2>
      ...
      <div className="mt-12 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-12 px-8 rounded-xl border border-gray-200 sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Link to="/auth/register" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-teal-600 bg-teal-50 hover:bg-teal-100">
                Create an account
              </Link>
            </div>
          </div>
