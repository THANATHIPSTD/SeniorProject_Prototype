...
const tooth11Url = "/teeth-svgs/11.svg";
const tooth13Url = "/teeth-svgs/13.svg";
const tooth14Url = "/teeth-svgs/14.svg";
const tooth16Url = "/teeth-svgs/16.svg";
const tooth14OcclUrl = "/teeth-svgs/14_occl.svg";
const tooth16OcclUrl = "/teeth-svgs/16_occl.svg";
...
export function destroyOdontogram() {
  ...
  // We do not clear the innerHTML of controls (e.g. #modsChecks, #cariesChecks)
  // because React preserves these nodes in Strict Mode between effects. 
  // Clearing them would leave them permanently blank since wireControls() only runs once per node.
